...
[ps_rating]
		<div class='bwbps_postlink_top_rt bwbps_postlink'>
			<a href='[post_url]' title='Visit image page.'><i class='fa fa-link'></i></a>
		</div>
	</div>
...
";
    ...
    function getPSDefaultOptions() {		$psOptions = get_option($this->adminOptionsName);		if(!empty($psOptions)) {
