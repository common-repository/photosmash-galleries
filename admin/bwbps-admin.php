...
<div id='bwbps_thumbnails'>
	<table class="form-table">
			<tr>
			<th></th>
			<td><a style='color: #d54e21 !important; text-decoration: none !important;' href='<?php echo PHOTOSMASHWEBHOME; ?>tutorials/sizing-and-resizing-images/'  target='_blank' title='Video tutorial on sizing and resizing images.'>Get Help <i class="fa fa-life-ring"></i></a> - video tutorial on image sizes.</td>
			</tr>
...
<?php
	...
	$args = array(
		...
		Set Page you want to have a gallery/image viewer on
			...
			<tr>
				...
				<td>
					<input type="number" id="ps_img_perpage" name="ps_img_perpage" value="<?php echo (int)$psOptions['img_perpage']; ?>" min="0" max="999"> <a href='javascript: void(0);' class='psmass_update' id='save_ps_img_perpage' title='Update ALL GALLERIES with this value.'><i class="fa fa-floppy-o"></i></a>
			...
			<tr>
				...
				<td>
					<input type="number" name="ps_img_perrow" value="<?php echo (int)$psOptions['img_perrow']; ?>" min="0" max="999"> <a href='javascript: void(0);' class='psmass_update' id='save_ps_img_perrow' title='Update ALL GALLERIES with this value.'><i class="fa fa-floppy-o"></i></a>
    ...
    <div id="bwbps_uploading">
        <table class="form-table">
            ...
            <tr>
				<th><?php _e('Minimum role to upload photos', 'photosmash'); ?></th>
				<td>
					<select name="ps_contrib_role">
						<option value="-1" <?php if($psOptions['contrib_role'] == -1) echo 'selected'; ?>>Anybody</option>
						<option value="0" <?php if($psOptions['contrib_role'] == 0) echo 'selected'; ?>>Subscribers</option>
						<option value="1" <?php if($psOptions['contrib_role'] == 1) echo 'selected'; ?>>Contributors/Authors</option>
						<option value="10" <?php if($psOptions['contrib_role'] == 10) echo 'selected'; ?>>Admin</option>
                    ...
                    <br><small><b>Authors</b> and <b>administrators</b> will not need moderation, even if selected below. <b>Contributors</b>, <b>Subscribers</b>, and <b>Anybody</b> will obey moderation settings.</small>
				</td>
			</tr>
			<tr>
				<th><?php _e('Image moderation', 'photosmash'); ?></th>
...
<?php 
	...
	function printManageImages()
	{
		...
		?>&TB_iframe=true&width=640&height=310' class='thickbox' onclick='return false;'><i class="fa fa-plus-circle"></i> Add Images</a> | 
		<?php
		}
