 ...
 * Copyright 2015-2016 Ciprian Popescu (email: getbutterfly@gmail.com)
 *
...
define('PHOTOSMASHVERSION', '1.2.0');

define('PHOTOSMASHWEBHOME', 'https://getbutterfly.com/wordpress-plugins/photosmash-galleries/');
...
function photosmash_init() {
	load_plugin_textdomain('photosmash', false, dirname(plugin_basename(__FILE__)) . '/languages/');
}
add_action('plugins_loaded', 'photosmash_init');
